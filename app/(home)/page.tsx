      ...
      <section className="grid grid-cols-1 md:grid-cols-6 gap-6">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700 transition-all hover:shadow-md">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-xs font-medium text-gray-500 dark:text-gray-400">Nombre de transactions</p>
                  {
                    isLoading ? (
                      <div className="mt-2">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700 transition-all hover:shadow-md">
              <div className="flex justify-between items-start">
                <div>
                  <p className="text-sm font-medium text-gray-500 dark:text-gray-400">Transactions (CZK)</p>
                  {
                    isLoading ? (
                      <div className="mt-2">
                        <div className="flex items-center space-x-2">
        ...
        <div className="col-span-1 md:col-span-2 h-full">
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-5 border border-gray-100 dark:border-gray-700 h-full space-y-4">
            <div className="mb-4">
              <h3 className="font-medium text-gray-800 dark:text-gray-200">Dominance des transactions</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400">Répartition des transactions enregistrées</p>
            </div>

            <div className='h-[350px]'>
              <TypeTransactionChart />
            </div>
