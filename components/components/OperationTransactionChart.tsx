...
import { getTransactionsOperation } from '@/app/actions';
import { TransactionOperation, TypeTransLoan } from '@/lib/types';
...
const OperationTransactionChart = ({ type }: TypeTransLoan) => {
    const [isLoading, setIsLoading] = useState<boolean>(true);
    const [transactionOperation, setTransactionOperation] = useState<TransactionOperation[]>([]);
                    ...
                    <ResponsiveContainer width="100%" height="80%">
                        <PieChart>
                            <Pie
                                ...
                                dataKey="proportion"
                            >
                                {transactionOperation.map((entry, index) => (
                                    <Cell
                                        key={`cell-${index}`}
...
export default OperationTransactionChart;